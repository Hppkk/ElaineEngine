            ...
            else
            {
                ...
                if (m_mat[0][0] >= m_mat[1][1])
                {
                    ...
                    if (m_mat[0][0] >= m_mat[2][2])
                    {
                        ...
                        axis.x = 0.5f * sqrt(m_mat[0][0] - m_mat[1][1] - m_mat[2][2] + 1.0f);
                    ...
                    else
                    {
                        ...
                        axis.z = 0.5f * sqrt(m_mat[2][2] - m_mat[0][0] - m_mat[1][1] + 1.0f);
                ...
                else
                {
                    ...
                    {
                        axis.y = 0.5f * sqrt(m_mat[1][1] - m_mat[0][0] - m_mat[2][2] + 1.0f);
