...
#define RHI_FALSE                          false
    ...
    enum class ELAINE_IMAGE_TYPE : uint8_t
    {
        ELAINE_IMAGE_TYPE_UNKNOWM = 0,
        ELAINE_IMAGE_TYPE_2D
    };
    ...
    struct RHISubpassDescription
    {
        ...
        const RHIAttachmentReference*   pInputAttachments = nullptr;
        uint32_t                        colorAttachmentCount;
        const RHIAttachmentReference*   pColorAttachments = nullptr;
        const RHIAttachmentReference*   pResolveAttachments = nullptr;
        const RHIAttachmentReference*   pDepthStencilAttachment = nullptr;
    ...
    struct RHISpecializationInfo
    {
        ...
        const RHISpecializationMapEntry**   pMapEntries = NULL;
        size_t                              dataSize;
    ...
    struct RHIRenderPassBeginInfo
    {
        ...
        RHIRenderPass*              renderPass = NULL;
        RHIFramebuffer*             framebuffer = NULL;
        RHIRect2D                   renderArea;
        uint32_t                    clearValueCount;
        const RHIClearValue*        pClearValues = NULL;
    };
    ...
    struct RHISwapChainDesc
    {
        ...
        RHIViewport*                viewport = NULL;
        RHIRect2D*                  scissor = NULL;
        std::vector<RHIImageView*>  imageViews;
    };

    struct RHIDepthImageDesc
    {
        RHIImage*           depth_image = NULL;
        RHIImageView*       depth_image_view = NULL;
